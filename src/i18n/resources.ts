export const resources = {
  en: {
    translation: {
      ...
      open: 'Open',
      openCentralRepo: 'Open Skills storage path',
      openCentralRepoShort: 'Skills Path',
      openSkillOnGithub: 'Open on GitHub',
      openSkillOnGithubAria: 'Open skill source on GitHub',
      update: 'Update',
      remove: 'Remove',
      ...
      statsTotal: 'Managed Skills',
      statsToolsActive: 'AI Products Detected',
      statsSynced: 'Fully Synced',
      statsLastUpdated: 'Last Updated',
      statsOf: '{{total}} AI products supported',
      toolsDetailTitle: 'AI Product Support',
      toolsDetailInstalled: 'Detected on this machine',
      toolsDetailNotInstalled: 'Not detected',
      statsPartial: '{{count}} partial',
      filterAll: 'All',
      filterGit: 'Git',
      filterLocal: 'Local',
      sectionGitSkills: 'Git Skills',
      sectionLocalSkills: 'Local Skills',
      navMySkillsTooltip: 'My Skills',
      navExploreTooltip: 'Explore',
      navSettingsTooltip: 'Settings',
      navLanguageTooltip: 'Switch Language',
      addSkill: 'Add Skill',
      skillCardDetail: 'View detail',
      skillSyncPanel: 'Sync Controls',
      skillBadgeSynced: 'Synced',
      skillBadgePartial: '{{count}} synced',
      syncNow: 'Sync Now',
      collapse: 'Collapse',
      expand: 'Expand',
      tools: {
  ...
  zh: {
    translation: {
      ...
      copyFailed: '复制失败',
      open: '打开',
      openCentralRepo: '打开Skills存储路径',
      openCentralRepoShort: 'Skills路径',
      openSkillOnGithub: '在 GitHub 打开',
      openSkillOnGithubAria: '在 GitHub 打开技能来源',
      update: '更新',
      remove: '移除',
      localTab: '本地目录',
      gitTab: 'Git 仓库',
      ...
      statsTotal: '已管理技能',
      statsToolsActive: '已检测 AI 产品',
      statsSynced: '已完整同步',
      statsLastUpdated: '最近更新',
      statsOf: '共支持 {{total}} 款 AI 产品',
      toolsDetailTitle: 'AI 产品支持情况',
      toolsDetailInstalled: '已在本机检测到',
      toolsDetailNotInstalled: '未检测到',
      statsPartial: '{{count}} 部分同步',
      filterAll: '全部',
      filterGit: 'Git',
      filterLocal: '本地',
      sectionGitSkills: 'Git 技能',
      sectionLocalSkills: '本地技能',
      navMySkillsTooltip: '我的技能',
      navExploreTooltip: '探索',
      navSettingsTooltip: '设置',
      navLanguageTooltip: '切换语言',
      addSkill: '添加技能',
      skillCardDetail: '查看详情',
      skillSyncPanel: '同步控制',
      skillBadgeSynced: '已同步',
      skillBadgePartial: '{{count}} 个已同步',
      syncNow: '立即同步',
      collapse: '收起',
      expand: '展开',
      tools: {
